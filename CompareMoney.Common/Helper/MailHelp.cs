...
namespace NIO.VI.Jobs.Tools
{
    public class MailHelp
    {
        ...
        public static async Task SendMailAsync(string smtpserver, string userName, string pwd, string toMail, string subj, string bodys, string fromMail = null, string nickName = null, bool enableSsl = false, Dictionary<Stream, string> attachments = null)
        {
